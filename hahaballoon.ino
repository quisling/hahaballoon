...
#undefine platformIO
#ifdef platformIO
// Arduino compatibility header ( things like String instead of std::string )
#include <Arduino.h>
...
// For bit-banged serial ports
#include <SoftwareSerial.h>

// Configure TinyGSM library, this crappy library needs the definitions before the library is included.
...
RTC_DATA_ATTR static time_t now;        // remember last boot in RTC Memory
...
void setup() {
    ...
    SerialMon.println("Current time:" + String(now));
    BLEDevice::init("");
